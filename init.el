...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (spaceline smex ido-vertical-mode org-bullets beacon nlinum-relative evil-commentary evil-surround oceanic-theme nimbus-theme spacemacs-theme which-key use-package evil-visual-mark-mode))))
(custom-set-faces
